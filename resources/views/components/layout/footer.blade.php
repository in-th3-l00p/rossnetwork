            ...
            <div class="grid grid-cols-2 gap-8 xl:col-span-2">
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    ...
                    <div class="mt-10 md:mt-0">
                        <h3 class="text-sm/6 font-semibold text-gray-900">Learn more</h3>
                        <ul role="list" class="mt-6 space-y-4">
                            <li>
                                <a href="#" class="text-sm/6 text-gray-600 hover:text-gray-900">About us</a>
                            </li>
                            <li>
            ...
            <div class="mt-10 xl:mt-0">
                ...
                <form class="mt-6 sm:flex sm:max-w-md">
                    ...
                    <input type="email" name="email-address" id="email-address" autocomplete="email" required
                        class="w-full min-w-0 rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-dark placeholder:text-gray-400 focus:outline focus:outline-2 focus:outline-darker sm:w-64 sm:text-sm/6 xl:w-full"
                        placeholder="Enter your email">
                    <div class="mt-4 sm:ml-4 sm:mt-0 sm:shrink-0">
                        <button type="submit"
                            class="flex w-full items-center justify-center rounded-md bg-dark px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-darker focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-darker">Subscribe</button>
                    </div>
                </form>
            </div>
        </div>
        <div
            ...
            <div class="flex gap-x-6 md:order-2">
                ...
                >
                    ...
                    <x-mdi-web class="size-6" />
                </a>
                <a 
                    href="https://www.instagram.com/_cata_0303/" 
                    target="_blank" 
                    class="text-gray-600 hover:text-gray-800"
                >
                ...
                <a href="https://x.com/CatalinTis2325" class="text-gray-600 hover:text-gray-800">
                ...
                <a href="https://github.com/in-th3-l00p" class="text-gray-600 hover:text-gray-800">
            ...
            <a 
                href="https://tiscacatalin.com"
                target="_blank"
                class="mt-8 text-sm/6 text-gray-600 md:order-1 md:mt-0"
            >
                &copy; 2025 Tisca Catalin, All rights reserved.
            </a>
        </div>
    </div>
</footer>