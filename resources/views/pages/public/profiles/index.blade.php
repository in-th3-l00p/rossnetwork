        ...
        <div class="bg-light2 py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0">
                    ...
                    <h2 class="mt-2 text-5xl font-semibold tracking-tight text-zinc-900 sm:text-7xl">{{ __("public.profiles.header.title") }}</h2>
                    <p class="mt-8 text-pretty text-lg font-medium text-zinc-500 sm:text-xl/8">{{ __("public.profiles.header.subtitle") }}</p>
                </div>
            </div>
        </div>
